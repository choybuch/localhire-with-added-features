  ...
  return dashData && (
    <div className='m-5'>
      ...
      <div className='flex flex-wrap gap-3'>
        <DashboardStat icon={assets.earning_icon} value={`${currency} ${dashData.earnings}`} label='Earnings' />
        <DashboardStat icon={assets.appointments_icon} value={dashData.appointments} label='Appointments' />
